...
# pushd /data/zpq/code_135/test_google_football/pymarl2-master/football/third_party/gfootball_engine && cmake . && make -j $PARALLELISM && popd
# pushd /data/zpq/code_135/test_google_football/pymarl2-master/football/third_party/gfootball_engine && ln -sf libgame.$LIB_EXTENSION libgame.so && popd
# pushd /data/zpq/code_135/test_google_football/pymarl2-master/football/third_party/gfootball_engine && ln -sf libgame.$LIB_EXTENSION _gameplayfootball.so && popd
