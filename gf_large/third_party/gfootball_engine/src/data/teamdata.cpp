...
TeamData::TeamData(int teamDatabaseID, const std::vector<FormationEntry> &f) {
  ...
  const std::string formationString =
      ...
      "<p12><position> -1.0, -0.45</position><role>CB</role></p12>"
      "<p13><position> -1.0, 0.45</position><role>CB</role></p13>"
      "<p14><position> -0.7,  0.55</position><role>LB</role></p14>"
      "<p15><position> -0.7, -0.55</position><role>RB</role></p15>"
      "<p16><position>  0.0,  0.25 </position><role>CM</role></p16>"
      "<p17><position> -0.4,  0.0 </position><role>CM</role></p17>"
      "<p18><position>  0.0, -0.25 </position><role>CM</role></p18>"
      "<p19><position>  0.6,  0.55 </position><role>LM</role></p19>"
      "<p20><position> 1.0,  0.1 </position><role>CF</role></p20>"
      "<p21><position> 0.6, -0.55 </position><role>RM</role></p21>"
      "<p22><position> -0.7,  0.35</position><role>LB</role></p22>"
      "<p23><position> -1.0,  0.55</position><role>CB</role></p23>"
      "<p24><position> -1.0, -0.55</position><role>CB</role></p24>"
      "<p25><position> -0.7, -0.35</position><role>RB</role></p25>"
      "<p26><position>  0.0,  0.1 </position><role>CM</role></p26>"
      "<p27><position> -0.3,  0.0 </position><role>CM</role></p27>"
      "<p28><position>  0.0, -0.1 </position><role>CM</role></p28>"
      "<p29><position>  0.6,  0.35 </position><role>LM</role></p29>"
      "<p30><position> 0.6, -0.35 </position><role>RM</role></p30>";
  ...
  playerData.push_back(new PlayerData(222, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(277, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(155, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(48, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(99, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(356, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(195, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(122, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(23, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(311, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(211, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(111, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(132, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(66, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(191, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(388, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(166, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(78, teamDatabaseID == 3));
  playerData.push_back(new PlayerData(266, teamDatabaseID == 3));
